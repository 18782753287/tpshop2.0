...
<div class="tpshop-tm-hander p">
    ...
    <div class="nav-middan-z p">
        <div class="header w1224">
            ...
            <div class="ecsc-join">
                <?php $pid =2;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1504072800 and end_time > 1504072800 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
